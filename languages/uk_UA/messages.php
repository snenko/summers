...
//    Zend_Validate_StringLength::TOO_LONG  => 'Длина введённого значения больше чем %max% символов',
    //Zend_Validate_File_Exists::DOES_NOT_EXIST=> 'Зображення не завантажено',
    //Zend_Validate_File_Upload::NO_FILE=> 'Зображення не завантажено',
    //File 'picture' was not uploaded
...
// Zend_Validate_Alnum
    ...
    //111"'%value%' was not found in the haystack" => "'%value%' не знайдено в списку допустимих значень",
    // Zend_Validate_Int
